...
function AddOpinionForm({ onAddOpinion }) {
    ...
    const [isSubmitting, setIsSubmitting] = useState(false); // Flaga do zarządzania stanem ładowania
    ...
    const handleSubmit = async (e) => {
        ...
        setIsSubmitting(true); // Rozpocznij proces wysyłania
        ...
        try {
            ...
            setIsSubmitting(false); // Zakończ proces wysyłania
            setName("");
            setRating(0);
            setText("");
        }
